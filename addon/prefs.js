...
pref("locale", "auto");
pref("mineruBackend", "cloud");
pref("mineruLocalBaseUrl", "http://127.0.0.1:8000");
pref("mineruLocalHost", "127.0.0.1");
pref("mineruLocalPort", "8000");
pref("mineruLocalLanguage", "ch");
pref("mineruLocalBackend", "hybrid-auto-engine");
pref("mineruLocalParseMethod", "auto");
pref("mineruLocalFormula", true);
pref("mineruLocalTable", true);
