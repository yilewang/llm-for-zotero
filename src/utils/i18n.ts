...
const zhCN: Record<string, string> = {
  ...
  "Clean synced MinerU packages": "清理已同步的 MinerU 包",
  "MinerU sync disabled. Existing synced packages are kept until cleaned.": "MinerU 同步已禁用。已有同步包会保留，直到手动清理。",
  ...
  "Cleaning synced MinerU packages…": "正在清理已同步的 MinerU 包…",
  "Cleaned synced MinerU packages": "已清理同步的 MinerU 包",
  ...
  "Recommended official Codex integration. Runs the local `codex app-server` CLI and routes turns through it. Run `codex login` first.": "推荐的官方 Codex 集成方式。它会运行本地 `codex app-server` CLI 并通过它处理对话。请先运行 `codex login`。",
