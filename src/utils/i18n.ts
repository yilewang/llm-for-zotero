...
const zhCN: Record<string, string> = {
  ...
  "Using note: %s": "使用笔记: %s",
  "Using note: %s with parent paper context %s": "使用笔记: %s（附带父论文上下文 %s）",
  "Using note: %s; parent item has no PDF context": "使用笔记: %s；父条目没有 PDF 上下文",
  "Using context: %s (active tab)": "使用上下文: %s（活动标签页）",
  "using the selected %s as context": "使用选中的 %s 作为上下文",
  "No active tab PDF context (tab=%s, type=%s, tabType=%s, dataKeys=%s)": "没有活动标签页 PDF 上下文 (tab=%s, type=%s, tabType=%s, dataKeys=%s)",
  "Ready": "就绪",
