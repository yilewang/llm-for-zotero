...
export function buildZoteroEnvironmentManifest(params: {
  ...
  lines.push(
    ...
    "- Citations: use the provided sourceLabel for paper-grounded claims. When paper_read returns exact passages, include 1-3 short blockquotes from those already-returned passages when useful for grounding the answer. Do not call tools solely to discover quotes or page numbers; the UI citation binder may resolve page links after rendering.",
